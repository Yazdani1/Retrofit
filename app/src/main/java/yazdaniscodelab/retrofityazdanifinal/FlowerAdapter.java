...
public class FlowerAdapter extends RecyclerView.Adapter<FlowerAdapter.MyHolder> {
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        holder.mFlwoerPrice.setText(Double.toString(flower.getPrice()));
    ...
    public Flower getallFlower(int position){
    ...
    public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyHolder(View view){
            ...
            mFlwoerPrice=(TextView)view.findViewById(R.id.flowerPrice_xml);
